...
### Ajouté
- **E-facture XML (réforme 2026-2027, socle Factur-X)** : bouton « E-facture (XML) » dans le détail de chaque facture (profil France) qui génère et partage le fichier structuré normalisé (UN/CEFACT CII, profil EN 16931) — le format que les plateformes de dématérialisation acceptent tel quel. Vendeur (SIREN, TVA intracom), client (SIRET), lignes avec quantités décimales et taux exacts, ventilation TVA par taux, avoirs en type 381 avec référence à la facture d'origine, mention d'exonération art. 293 B en franchise. L'incrustation du XML dans le PDF (Factur-X complet, PDF/A-3) viendra dans une étape ultérieure.
